<div class="row">
	<div class="row header_main">
        	<div class="col-md-2 col-sm-2 col-xs-12" align="center"><img src="images/ngplogo.png" width="300" height="75"></div>
            <div class="col-md-7 col-sm-7 col-xs-12 main_name" align="center">COLLEGE MANAGEMENT SYSTEM</div>
            <div class="col-md-3 col-sm-3 col-xs-12" align="center">
                <div class="social_icons">
                    <ul>
                        <li><a href="https://www.facebook.com" target="_blank"><img src="images/fb1.png" width="32" height="32" /></a></li>
                        <li><a href="https://plus.google.com" target="_blank"><img src="images/google-plus.png" width="32" height="32" /></a></li>
                        <li><a href="https://www.linkedin.com/in" target="_blank"><img src="images/li1.png" width="32" height="32" /></a></li>
  ...
  <div class="row">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
             ...
             <li><a href="view-queries-complaints.php">QUERIES/COMPLAINTS</a></li>
             <li class="dropdown">
