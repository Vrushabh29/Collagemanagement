...
<!-- Start Content -->
    ...
    <div class="row m40_0">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
             ...
             <select class="form-control modal_form" name="qualification">
			 ...
			 <input type="text" class="form-control modal_form" name="subject" value="<?php echo $row['subject'];?>" required="required" placeholder="Subject Name"/>
