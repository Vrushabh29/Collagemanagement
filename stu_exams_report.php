     ...
     <div class="col-md-2"></div>
    	<div class="col-md-8">
        	...
        	<div style="border:1px solid #06F;">
			    <div class="inner_strip" align="center"> <b>MARKS : <?php echo $crt_count?> / <?php echo $tot_ques?></b> </div>  
                 <div class="row course_border">
                    <div class="p20_0"><div class="exam_ret">Total number of questions</div> <div class="exam_ret_1">:</div> <div class="exam_ret_2"><?php echo $tot_ques?></div></div>
